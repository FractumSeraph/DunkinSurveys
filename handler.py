    ...
    try:
        ...
        try:
            ...
            bot.sendMessage(chat_id=update.message.chat_id,
                            text='Your current language is {}.'.format(current_language))
        except KeyError:
            bot.sendMessage(chat_id=update.message.chat_id,
                            text='Your current language is Default ({}).'.format(available_langs[DEFAULT_LANG]))

    else:
        if language in available_langs:
            lang_dict[update.message.chat_id] = language
            bot.sendMessage(chat_id=update.message.chat_id,
                            text='Your language is now {}.'.format(available_langs[language]))
        else:
